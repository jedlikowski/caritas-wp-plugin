<div class="wrap">
  ...
  <p>Aby nadpisać szablon odpowiedzialny za wyświetlanie danego widoku należy w aktywnym motywie, w folderze
    ...
    <p>Pliki źródłowe znajdują się w folderze <code>templates</code> wewnątrz folderu zawierającego wtyczkę. Warto je
    ...
    <ul>
      ...
      <li><code><?php echo site_url('/platnosc-zakonczona'); ?></code> - <code>payment-success.php</code> (sukces
        płatności)</li>
      <li><code><?php echo site_url('/blad-platnosci'); ?></code> - <code>payment-success.php</code> (błąd płatności)
      </li>
    </ul>
